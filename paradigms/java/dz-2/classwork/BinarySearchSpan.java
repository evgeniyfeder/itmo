...
public class BinarySearchSpan {
   ...
   * arr[-1] = inf && arr[arr.length] = -inf &&
	...
	public static void main(String[] args) {
		...
		int left_side = binarySearchIter(arr, x), ride_side = binarySearchRec(arr, x); 
		System.out.printf("%d %d", left_side, ride_side - left_side + 1);
